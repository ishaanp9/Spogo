...
export const addUserInfoToHolder = (key, value) => {
  userInfoHolderDict[key] = value;
}

export const getUserHolderDict = () => {
  return userInfoHolderDict;
}
...
export const addExperienceItem = (title, duration, description, idNum) => {
  const CardObjectExample = new ExpTrophyCardObject(
    title,
    duration,
    description,
    idNum
