...
const SportPosition = () => {
  ...
  return (
    <div className="sportPositionContainer">
      <p className="sportPositionFormHeader">Hello [name]! Welcome to Spogo!</p>
      <p className="sportPositionHeadlineHeader">Let's start creating your athletic profile.</p>
      <form>
        <div className="sportPositionInputForms">
          ...
          {positionIcon === 'BsPlus' ? (
            <p className="sportsNoPostionText">I don't have a position.</p>
          ) : null}
